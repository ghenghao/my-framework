...
<form id="customer_form" enctype="multipart/form-data" method="post" action="${BASE}/customer_create">
	<table>
		<tr>
			<td>客户名称：</td>
...
<script src="${BASE}/asset/lib/jquery/jquery-1.7.1.js"></script>
<script src="${BASE}/asset/lib/jquery/jquery.form.js"></script>
